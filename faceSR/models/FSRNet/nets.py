...
class CoarseSRNetwork(nn.Module):
    ...
    def __init__(self):
        ...
        # k3n64s1： kernel size 3×3, the feature map number to be 64 ,the stride to be 1.
...
class FSRNet(nn.Module):
    ...
    def __init__(self, hmaps_ch, pmaps_ch):
        ...
        if self.pmaps_ch > 0:
            ...
            # self.prior_conv2 = nn.Conv2d(256, self.pmaps_ch, kernel_size=1)  # pmaps (parsing maps)
